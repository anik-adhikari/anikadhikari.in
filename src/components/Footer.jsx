...
export default function Footer() {
    return (
        <section id="footer">
            <div className="relative mx-auto flex w-full max-w-7xl items-center justify-center mt-10 pt-10">
                ...
                <div className="relative z-10 flex w-full flex-col items-center justify-between space-y-6 px-8 py-16 text-center md:flex-row">
                    <div>
                        ...
                        <p className="mt-4 max-w-lg text-center text-base text-neutral-600 md:text-left dark:text-neutral-300">
                            Copyright &#169; 2025 <a href="./#home"><b><u>Anik Adhikari</u></b></a> | All Rights
        Reserved
                        </p>
                    </div>
                    <div className="flex flex-col gap-4 sm:flex-row">
                        <button className="inline-flex items-center justify-center rounded-lg border border-neutral-300 bg-white px-8 py-3 text-sm font-medium text-neutral-700 shadow-sm transition-all duration-200 hover:bg-neutral-50 hover:shadow-md dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700" onClick={() => window.open("https://www.linkedin.com/in/anikadhikari", "_blank")}>
                            Connect
                        </button>
                    </div>
                </div>
